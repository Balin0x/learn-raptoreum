...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | label | string | False |  | If set, should be a valid label name to return only incoming transactions |
| 2 | count | numeric | False | 10 | The number of transactions to return |
| 3 | skip | numeric | False | 0 | The number of transactions to skip |
| 4 | include_watchonly | boolean | False | false | Include transactions to watch-only addresses (see 'importaddress') |
