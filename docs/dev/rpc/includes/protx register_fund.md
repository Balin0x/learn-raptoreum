## protx register_fund
Creates, funds and sends a ProTx to the network. The resulting transaction will move the required collateralAmount to the address specified by collateralAddress, which will then function as the collateral of your smartnode. A few of the limitations seen in the arguments are temporary and might be lifted after DIP3 is fully deployed.
Requires wallet passphrase to be set with `walletpassphrase` call if wallet is encrypted.

### Arguments
| Position | Name | Type | Required | Default | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | collateralAddress | string | True |  | The Raptoreum address to send the collateral to. |
| 2 | collateralAmount | numeric | True |  | The collateral amount to be sent to collateralAddress. |
...
| 9 | fundAddress | string | False |  | If specified, wallet will only use coins from this address to fund ProTx. If not specified, payoutAddress is the one that is going to be used. |
...
### Examples
```bash
raptoreum-cli protx register_fund "XrVhS9LogauRJGJu2sHuryjhpuex4RNPSb" "1.2.3.4:1234" "Xt9AMWaYSz7tR7Uo7gzXA3m4QmeWgrR3rr" "93746e8731c57f87f79b3620a7982924e2931717d49540a85864bd543de11c43fb868fd63e501a1db37e19ed59ae6db4" "Xt9AMWaYSz7tR7Uo7gzXA3m4QmeWgrR3rr" 0 "XrVhS9LogauRJGJu2sHuryjhpuex4RNPSb"
```
